...
export class Nes {
    ...
    */
    ...
    // smb3Hack(){
    //     if (this.inputController.Key_Action_Start && this.startCounter1==false){
    //         this.startCounter1 = true;
    //         console.log('start counter 1');
    //     }
    //     if (this.startCounter1 && this.inputController.Key_Action_Start==false && this.startCounter2==false){
    //         this.startCounter2 = true;
    //         console.log('start counter 2');
    //     }
    //     if (this.startCounter2 && this.inputController.Key_Action_Start==true && this.startCounter3==false){
    //         this.startCounter3 = true;
    //         console.log('start counter 3');
    //         this.smb3StartHack=true;
    //     }
